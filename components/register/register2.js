        ...
        <div className={styles.main}>
            <div className={styles.cardbody}>
                ...
                <div className={styles.inputstyle}>
                    <h5 className={styles.inputlabel} className={styles.inputlabel}>身高</h5>
...
                    <label for="html">有</label>
                    <input type="radio" id="html" name="fav_language" value="HTML"></input>
                    <label for="html">沒有</label>
                </div>
                <div className={styles.inputstyle}>
                    <h5 className={styles.inputlabel}>酒精</h5>
                    <input type="radio" id="html" name="fav_language" value="HTML"></input>
                    <label for="html">滴酒不沾</label>
                    <input type="radio" id="html" name="fav_language" value="HTML"></input>
                    <label for="html">小酌</label>
                    <input type="radio" id="html" name="fav_language" value="HTML"></input>
                    <label for="html">酒豪</label>
                </div>
                <div className={styles.inputstyle}>
...
                    <label for="html">女</label>
                ...
                <div className={styles.inputstyle}>
                <label for="w3review" className={styles.inputlabel}>自我介紹</label>
